INSERT INTO equipos VALUES
    ...
    ('EQ-003', 'Compresor C3',          'Neumático',  'Atlas',    'GA-30',   'SN-CCC-003', 'Nave C', '2019-11-20', 'Operativo',          'Media'),
    ('EQ-004', 'Panel Eléctrico P4',    'Eléctrico',  'Schneider','XB5',     'SN-DDD-004', 'Nave A', '2022-03-05', 'En Mantenimiento',   'Alta'),
...
INSERT INTO tecnicos VALUES
    ...
    ('TEC-003', 'Luis Ramos',      'RALU850303CCC', '9215554433', 'luis@sigomei.mx',   'Eléctrico',  'II',  '2019-01-10', 'Inactivo'),
...
VALUES
    -- Orden programada (sin técnico aún)
    ...
    ('OM-003', 'EQ-003', 'TEC-004', 'Preventivo',
     ...
     'Ajuste y lubricación del compresor C3',   1500.00, 1650.00, 'Finalizada'),

    -- Orden cancelada
    ('OM-004', 'EQ-006', NULL,      'Correctivo',
     '2025-04-15', NULL, NULL,
     'Reparación de aspas del ventilador V6',   800.00,  NULL, 'Cancelada'),

    -- Orden programada para equipo con criticidad Alta
    ('OM-005', 'EQ-004', NULL,      'Predictivo',
     '2025-08-10', NULL, NULL,
     'Termografía del panel eléctrico P4',      2200.00, NULL, 'Programada'),

    -- Orden finalizada con equipo hidráulico
    ('OM-006', 'EQ-005', 'TEC-005', 'Preventivo',
     '2025-03-01', '2025-03-02', '2025-03-04',
     'Cambio de sellos hidráulicos en prensa H5', 4100.00, 3980.00, 'Finalizada');