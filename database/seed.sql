...
INSERT INTO tecnicos (id_tecnico_int, id_tecnico, fecha_ingreso, nivel_certificacion, especialidad) VALUES
    (4, 'TEC-001', '2019-06-01', 'III', 'Mecanico'),
    (5, 'TEC-002', '2021-03-15', 'II',   'Electrico');
...
INSERT INTO equipos (id_equipo_int, id_equipo, nombre, tipo, marca, modelo, numero_serie, ubicacion_planta, fecha_instalacion, estado_operativo, criticidad, registrado_por_int) VALUES
    ...
    (3, 'EQ-003', 'Motor Electrico M3',       'Motor',         'WEG',         'W22 200HP',   'SN-WEG-003', 'Nave C – Zona 4',  '2021-01-10', 'En Mantenimiento', 'Alta',  NULL),
    (4, 'EQ-004', 'Bomba Hidraulica H4',     'Bomba',         'Parker',      'PVH074',      'SN-PAR-004', 'Sala de Bombas',   '2019-11-30', 'Operativo',        'Media', NULL),
...
INSERT INTO ordenes_mantenimiento (id_orden_int, id_orden, id_equipo_int, id_tecnico_int, creado_por_int, descripcion_trabajo, tipo_mantenimiento, costo_estimado, costo_real, fecha_programada, fecha_inicio, fecha_cierre) VALUES
    (1, 'OM-001', 1, 4, NULL, 'Cambio de filtros y revisión de presion de aceite del compresor Atlas 01.',           'Mecanico',   1500.00, 1320.00, '2025-05-05', '2025-05-05 09:00:00', '2025-05-05 13:30:00'),
    (2, 'OM-002', 3, 5, NULL, 'Diagnostico y reparación de variador de frecuencia en Motor WEG W22.',                'Electrico',  8000.00, NULL,    '2025-05-12', '2025-05-12 08:00:00', NULL),
    (3, 'OM-003', 5, 4, NULL, 'Mantenimiento general de Torno CNC: calibracion, lubricacion y revisión electrica.', 'Mecanico',   3500.00, NULL,    '2025-05-15', NULL,                  NULL),
    (4, 'OM-004', 2, 5, NULL, 'Inspeccion predictiva de banda – analisis de vibración y termografia.',               'Electrico',   900.00,  870.00, '2025-04-28', '2025-04-28 10:00:00', '2025-04-28 14:00:00'),
    (5, 'OM-005', 4, 4, NULL, 'Sustitucion de sellos mecanicos y revision de caudal de bomba Parker.',               'Hidraulico', 2200.00, NULL,    '2025-05-20', NULL,                  NULL);
